...
OptionsMenu::OptionsMenu() {
  ...
  _musicData.bar->Size(glm::vec2(400.0f, 50.0f));
  _musicData.bar->BackgroundColor(glm::vec4(0.0f, 1.0f, 1.0f, 1.0f));
  _musicData.bar->FillColor(glm::vec4(1.0f, 0.0f, 1.0f, 1.0f));
  ...
  _musicData.downButton->Size(glm::vec2(50.0f, 50.0f));
  ...
  _musicData.downButton->Offset(glm::vec2(100.0f, 100.0f));
  _musicData.downButton->HandleSize(glm::vec2(50.0f, 50.0f));
  ...
  _musicData.upButton->Size(glm::vec2(50.0f, 50.0f));
  ...
  _musicData.upButton->Offset(glm::vec2(175.0f, 100.0f));
  _musicData.upButton->HandleSize(glm::vec2(50.0f, 50.0f));
  ...
  _soundData.bar->Size(glm::vec2(400.0f, 50.0f));
  _soundData.bar->BackgroundColor(glm::vec4(0.0f, 1.0f, 1.0f, 1.0f));
  _soundData.bar->FillColor(glm::vec4(1.0f, 0.0f, 1.0f, 1.0f));
  ...
  _soundData.downButton->Size(glm::vec2(50.0f, 50.0f));
  ...
  _soundData.downButton->Offset(glm::vec2(100.0f, 25.0f));
  _soundData.downButton->HandleSize(glm::vec2(50.0f, 50.0f));
  ...
  _soundData.upButton->Size(glm::vec2(50.0f, 50.0f));
  ...
  _soundData.upButton->Offset(glm::vec2(175.0f, 25.0f));
  _soundData.upButton->HandleSize(glm::vec2(50.0f, 50.0f));
  ...
  _brightnessData.bar->FillColor(glm::vec4(1.0f, 0.0f, 1.0f, 1.0f));
  ...
  _brightnessData.bar->Offset(glm::vec2(-325.0f, -50.0f));
  _brightnessData.text = std::make_shared< Engine::Renderer::Text >();
  _brightnessData.text->Size(1);
  _brightnessData.text->SetText("Brightness");
  ...
  _brightnessData.downButton->Size(glm::vec2(50.0f, 50.0f));
  ...
  _brightnessData.downButton->Offset(glm::vec2(100.0f, -50.0f));
  _brightnessData.downButton->HandleSize(glm::vec2(50.0f, 50.0f));
  ...
  _brightnessData.upButton->Offset(glm::vec2(175.0f, -50.0f));
  _brightnessData.upButton->HandleSize(glm::vec2(50.0f, 50.0f));
  ...
  _contrastData.bar->FillColor(glm::vec4(1.0f, 0.0f, 1.0f, 1.0f));
  ...
  _contrastData.bar->Offset(glm::vec2(-325.0f, -125.0f));
  _contrastData.text = std::make_shared< Engine::Renderer::Text >();
  _contrastData.text->Size(1);
  _contrastData.text->SetText("Contrast");
  ...
  _contrastData.downButton->Size(glm::vec2(50.0f, 50.0f));
  ...
  _contrastData.downButton->Offset(glm::vec2(100.0f, -125.0f));
  _contrastData.downButton->HandleSize(glm::vec2(50.0f, 50.0f));
  ...
  _contrastData.upButton->Offset(glm::vec2(175.0f, -125.0f));
  _contrastData.upButton->HandleSize(glm::vec2(50.0f, 50.0f));
  ...
  _gammaData.bar->FillColor(glm::vec4(1.0f, 0.0f, 1.0f, 1.0f));
  ...
  _gammaData.downButton->Size(glm::vec2(50.0f, 50.0f));
  ...
  _gammaData.downButton->Offset(glm::vec2(100.0f, -200.0f));
  _gammaData.downButton->HandleSize(glm::vec2(50.0f, 50.0f));
  ...
  _gammaData.upButton->Offset(glm::vec2(175.0f, -200.0f));
  _gammaData.upButton->HandleSize(glm::vec2(50.0f, 50.0f));
  ...
  _returnButton->Size(glm::vec2(150.0f, 50.0f));
