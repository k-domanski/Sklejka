...
namespace Engine {
  ...
  glm::mat4 Bone::InterpolateRotation(float animationTime) {
    ...
    float scaleFactor = GetScaleFactor(m_Rotations[r0Index].timeStamp,
                                       m_Rotations[r1Index].timeStamp, animationTime);
    glm::quat finalRotation =
        glm::slerp(m_Rotations[r0Index].rotation, m_Rotations[r1Index].rotation, scaleFactor);
  ...
  glm::mat4 Bone::InterpolateScale(float animationTime) {
    ...
    float scaleFactor =
        GetScaleFactor(m_Scale[s0Index].timeStamp, m_Scale[s1Index].timeStamp, animationTime);
